...
public class UserModel implements Serializable {
    ...
    @Column()
    private LocalDateTime firtsPaymentDate;
    ...
    public LocalDateTime getFirtsPaymentDate() {
        return firtsPaymentDate;
    }

    public void setFirtsPaymentDate(LocalDateTime firtsPaymentDate) {
        this.firtsPaymentDate = firtsPaymentDate;
    }
